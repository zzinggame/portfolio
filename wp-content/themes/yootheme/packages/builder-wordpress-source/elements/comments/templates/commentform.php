...
comment_form([
    ...
    'comment_field' => '<p class="comment-form-comment"><label class="uk-form-label" for="comment">' . _x('Comment', 'noun') . '</label><textarea class="uk-textarea" id="comment" name="comment" rows="8" required aria-required="true">' . '</textarea></p>',
