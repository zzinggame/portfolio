...
$title = $this->el($props['title_element'], [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => !$props['content'] && (!$props['meta'] || $props['meta_align'] == 'above-title') && (!$props['image'] || $props['image_align'] != 'between'),
    ],
...
$meta = $this->el($props['meta_element'], [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => $props['meta_align'] == 'below-content' || (!$props['content'] && ($props['meta_align'] == 'above-content' || ($props['meta_align'] == 'below-title' && !($props['image'] || $props['image_align'] == 'between')))),
    ],
]);
...
$content = $this->el('div', [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => !($props['meta'] && $props['meta_align'] == 'below-content'),
    ],
