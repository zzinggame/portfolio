...
$title = $this->el($element['title_element'], [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => !$props['content'] && (!$props['meta'] || $element['meta_align'] == 'above-title') && (!$props['image'] || $element['image_align'] != 'between'),
    ],
...
$meta = $this->el($element['meta_element'], [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => $element['meta_align'] == 'below-content' || (!$props['content'] && ($element['meta_align'] == 'above-content' || ($element['meta_align'] == 'below-title' && !($props['image'] || $element['image_align'] == 'between')))),
    ],
...
$content = $this->el('div', [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}' => !($props['meta'] && $element['meta_align'] == 'below-content'),
    ],
...
$grid = $this->el('div', [
    ...
    'class' => [
        ...
        'uk-flex-1 {@panel_expand: content}',
    ],
