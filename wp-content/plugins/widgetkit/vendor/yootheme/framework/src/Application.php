...
class Application extends Container
{
    ...
    {
        $response = null;
        $event = $this['events']->trigger(new Event('request', compact('request')), [$this]);
        ...
        if (isset($event['response'])) {
            ...
            $response = call_user_func_array(
                $callable,
                $this['controllers']->getArguments($request, $callable)
            );
            $event = $this['events']->trigger(
                new Event('response', compact('response', 'request')),
                [$this]
            );
        ...
        if (!$response instanceof Response) {
            throw new \LogicException(
                'Response must be of type YOOtheme\Framework\Routing\Response.'
            );
        }
    ...
    {
        $event = $this['events']->trigger(new Event('exception', compact('exception', 'request')), [
            $this,
        ]);
