        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-align" class="uk-select uk-form-width-medium" ng-model="widget.data['align']">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-breakpoint" class="uk-select uk-form-width-medium" ng-model="widget.data['breakpoint']">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input class="uk-checkbox" type="checkbox" ng-model="widget.data['alternate']"> {{'Alternate the media alignment' | trans}}</label>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input class="uk-checkbox" type="checkbox" ng-model="widget.data['gutter']"> {{'Show the grid gutter' | trans}}</label>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-gutter-vertical" class="uk-select uk-form-width-medium" ng-model="widget.data['gutter_vertical']">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input class="uk-checkbox" type="checkbox" ng-model="widget.data['divider']"> {{'Show horizontal dividers' | trans}}</label>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-animation-media" class="uk-select uk-form-width-medium" ng-model="widget.data['animation_media']">
                            <option value="none">{{'None' | trans}}</option>
                            <option value="fade">{{'Fade' | trans}}</option>
                            <option value="slide-small">{{'Slide Small' | trans}}</option>
                            <option value="slide-medium">{{'Slide Medium' | trans}}</option>
                            <option value="slide">{{'Slide 100%' | trans}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-animation-content" class="uk-select uk-form-width-medium" ng-model="widget.data['animation_content']">
                            <option value="none">{{'None' | trans}}</option>
                            <option value="fade">{{'Fade' | trans}}</option>
                            <option value="slide-small">{{'Slide Small' | trans}}</option>
                            <option value="slide-medium">{{'Slide Medium' | trans}}</option>
