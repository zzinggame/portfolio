            ...
            <li>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <div class="uk-margin-small">
                            <label><input class="uk-input uk-form-width-small" type="text" ng-model="widget.data['image_min_height']"> {{'Min. Height (px)' | trans}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-alignment" class="uk-select uk-form-width-medium" ng-model="widget.data['alignment']">
