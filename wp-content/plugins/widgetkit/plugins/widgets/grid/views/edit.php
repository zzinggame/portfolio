        ...
        <ul id="nav-content" class="uk-switcher">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-panel" class="uk-select uk-form-width-medium" ng-model="widget.data['panel']">
                            ...
                            <option value="sequence1">{{'Card Default/Card Primary' | trans}}</option>
                            <option value="sequence2">{{'Card Default/Card Secondary' | trans}}</option>
            ...
            <li>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-date-format" class="uk-select uk-form-width-medium" ng-model="widget.data['date_format']">
