        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input class="uk-checkbox" type="checkbox" ng-model="widget.data['link_media']"> {{'Link Media' || trans}}</label>
                    </div>
                </div>
                ...
                <label class="uk-form-label" for="wk-overlay">{{'Overlay' | trans}}</label>
                    <div class="uk-form-controls">
                        ...
                        <div class="uk-margin-small" ng-if="widget.data.overlay != 'none'">
                        ...
                        <div class="uk-margin-small" ng-if="widget.data.overlay != 'none'">
                            <label><input class="uk-checkbox" type="checkbox" ng-model="widget.data['overlay_background']"> {{'Show panel background' | trans}}</label>
                        </div>
                    </div>
                </div>
